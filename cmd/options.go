...
func init() {
	...
	//
	testconfig := flag.String("c", filepath.Join(defaultTestDir, "testconfig"), "the path which test config in")
	testsuite := flag.String("tsuite", filepath.Join(defaultTestDir, "testsuite"), "the path which testsuite json in")
	testcase := flag.String("tc", filepath.Join(defaultTestDir, "testcase"), "the path which test json in")
	keyword := flag.String("kw", filepath.Join(defaultTestDir, "keyword"), "the path which keyword in")
	statechart := flag.String("sc", filepath.Join(defaultTestDir, "statechart"), "the path which statechart in")

	testresource := flag.String("tr", filepath.Join(defaultTestDir, "testresource"), "the path which test resource in")
	testresults := flag.String("r", filepath.Join(defaultTestDir, "testresults"), "the path which test results in")
	js := flag.String("js", filepath.Join(defaultTestDir, "js"), "the path which functions defined with js in")
